...
export const Second = () => {
  return (
    <div className="my-9 lg:my-0    flex flex-col md:flex-row-reverse md:justify-center  lg:justify-center lg:gap-3 md:mx-6 md:my-12">
      <div className="flex items-center mx-2 md:items-start justify-center lg:items-start   ">
            <img src="./img/desktop.png" alt="bag" className="md:girl-bag lg:desktop-bag " />
      </div>
      <div className="flex  flex-col md:mr-28  md:mt-12 lg:mr-0 ">
        <div className="mt-6 md:mt-0 mb-6 mx-8  md:mx-0  md:justify-start  flex justify-center items-end ">
          ...
          <img src="./img/bag2.png" className="  md:white-bag1 lg:white-bag2 " alt="bag2" />
        </div>
