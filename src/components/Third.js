...
export const Third = () => {
    return (
        <div className="flex flex-col md:py-12 py-9 items-center justify-center px-4 md:px-6">
            <div >
            ...
            <div className="py-4 flex flex-wrap xs-screen gap-3 mx-auto items-center ">
